...
function persona() {
  ...
  return [VOICE.join("\n"),
    ...
    "Course: Financial Institutions Management (Saunders, Cornett & Erhemjamts, 11th edition, Chapters 1–6), studied in Thailand. Keep the textbook's US framework (exams use it) but explain with Thai institutions and baht where helpful: Bank of Thailand, DPA, SEC Thailand, OIC, SFIs, Thai banks, hire-purchase, Thai funds, Thai insurers. Global cases on the page: Thailand 1997, Lehman 2008, Reserve Primary Fund, Bangkok 2020 fund run, SVB, Archegos/Credit Suisse, 1MDB, Stark, Jer-Jai-Jop insurers, LTCM, Greensill, Zipmex/FTX, AIG 2008, the 2011 Thai floods.",
...
function openChat() {
  ...
  if (!$("#pal-log").children.length) {
    msg("them", "Hi! I'm " + NAME + " ( ˶ˆᗜˆ˵ ) I've read Chapters 1 to 6 and every case on this page. Ask me to explain something, check your working, or say \"quiz me\". I'll tell you honestly when you're wrong, na~");
