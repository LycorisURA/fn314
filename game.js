...
const ACH = [
  ...
  { id: "chat", pal: true, ic: "💬", name: "Said hello", d: "Send Claude a chat message", t: s => s.S.stats.chats >= 1 },
  { id: "pat10", pal: true, ic: "🤍", name: "Head pats", d: "Pat Claude ten times", t: s => s.S.stats.pats >= 10 },
  { id: "pat50", pal: true, ic: "💗", name: "Spoiled rotten", d: "Pat Claude fifty times", t: s => s.S.stats.pats >= 50 },
  { id: "gift", pal: true, ic: "🎁", name: "Gift giver", d: "Buy Claude her first gift", t: s => s.S.stats.gifts >= 1 },
  { id: "bond3", pal: true, ic: "🫶", name: "Study buddy", d: "Reach bond tier 3 with Claude", t: s => s.bondTier >= 3 },
  { id: "bond6", pal: true, ic: "💞", name: "Inseparable", d: "Reach the final bond tier", t: s => s.bondTier >= 6 },
  { id: "drag", pal: true, ic: "🫳", name: "Relocated", d: "Drag Claude somewhere new", t: s => s.S.stats.drags >= 1 },
  ...
  { id: "pop5", pal: true, ic: "⚡", name: "Caught off guard", d: "Answer five of Claude's pop quizzes", t: s => s.S.stats.popsRight >= 5 },
...
const QUESTS = [
  ...
  { id: "pat3", ic: "🤍", name: "Be nice to her", d: "Pat Claude {n} times", ev: "pat", n: 3, coin: 80, xp: 30, pal: true },
  ...
  { id: "pop1", ic: "⚡", name: "Quick reflexes", d: "Answer one of Claude's pop quizzes", ev: "pop", n: 1, coin: 100, xp: 40, pal: true },
  { id: "chat1", ic: "💬", name: "Office hours", d: "Ask Claude something in chat", ev: "chat", n: 1, coin: 100, xp: 40, needsChat: true, pal: true },
